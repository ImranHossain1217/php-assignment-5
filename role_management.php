...
<body>
    <div class="bg-gray-100 grid place-items-center min-h-screen">
        <div class="w-1/2 h-1/2 bg-blue-200 p-5">
            <h1 class="text-2xl font-semibold text-center uppercase">welcome to Admin Panel</h1>
            ...
            <div class="mt-2">
                ...
                <a class="bg-blue-500 text-white px-3 py-1 text-center rounded" href="create_role.php">Create Role</a>
            </div>
        </div>
    </div>
</body>
